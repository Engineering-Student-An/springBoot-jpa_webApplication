...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("상품 주문 시 상태는 ORDER여야 한다.", OrderStatus.ORDER, getOrder.getStatus());
    ...
    public void 주문취소() throws Exception {
        ...
        int orderCount = 2;
        Long orderId = orderService.order(member.getId(), book.getId(), orderCount);    // 주문 넣은것 까지가 given 절
